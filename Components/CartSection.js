      ...
      <div className="entire-section">
        ...
        >
          <div className="cart-details">
            ...
            >
              <img src={Empty} className="empty-cart-img" alt=""/>
            </div>
          ...
          >
            <div className="congrats">
              <p>
                ...
                <p style={{ marginTop: "5px", marginBottom: "0px" }}>
                  Use code <b>MANOJANKIT201</b> for 20% discount.
                </p>
              </p>
            </div>
            ...
            <div className="promocode">
              ...
              <button
                onClick={() => {
                  if (promocode === "MANOJANKIT201") {
                    TotalValue(totalPrice1);
                    setdiscountCode(promocode);
                    setCorrectCode(true);
                  } else if (promocode !== "MANOJANKIT201") {
                    setdiscountCode(promocode);
            ...
            <p
              ...
              className="applied"
            >
              <b>MANOJANKIT201</b> has been applied!
            </p>
            <p
              style={
